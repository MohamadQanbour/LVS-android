...
/**
 * Created by Alalaa Center on 25/08/2016.
 */
public class EmailOutboxRecyclerAdapter extends RecyclerView.Adapter<EmailOutboxRecyclerAdapter.MyViewHolder> {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
        ...
        public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
            menu.add(2, Menu.NONE,Menu.NONE,LvsApplication.APP_CTX.getString(R.string.delete));
    ...
    public EmailOutboxRecyclerAdapter(Context _ctx, int _res, List<Email> _data) {
        this.ctx = _ctx;
        this.data = _data;
        this.res = _res;
